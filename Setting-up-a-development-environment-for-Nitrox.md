...
1. Pull git repository locally (pass `--recursive` to `git clone` to init and clone submodules).(git clone https://github.com/SubnauticaNitrox/Nitrox.wiki.git/ --recursive)
